...
### `filter_N_seq/lib/kseq.h`, `filter_N_seq/lib/kstring.h`

- **Source:** **klib** — Attractive Chaos / Heng Li
- **Licence:** MIT — full text and original copyright notices in
  [`filter_N_seq/lib/LICENSE.txt`](filter_N_seq/lib/LICENSE.txt)
- Notices from the Broad Institute, Genome Research Ltd (GRL) and Yuta Mori appear in
  that file and are retained as received.
