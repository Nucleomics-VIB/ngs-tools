...
# 3. Classifies OTU sequences against the UNITE database using naive Bayes (sklearn)
# 4. Classifies OTU sequences against the UNITE database using Vsearch
#
...
get_classifier() {
  ...
  echo "DEBUG: Checking for classifier file: '${unite_dir}'" >&2
  ls -l "${unite_dir}/" >&2
  ...
  echo "DEBUG: ${sequences_name}"
  echo "DEBUG: ${taxonomy_name}"  
  echo "DEBUG: ${classifier_name}"
